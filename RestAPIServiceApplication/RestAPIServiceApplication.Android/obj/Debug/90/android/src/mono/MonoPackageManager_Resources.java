...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "RestAPIServiceApplication.Android.dll" comes first in this list. */
		"RestAPIServiceApplication.Android.dll",
		"EntityFramework.dll",
